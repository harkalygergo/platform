...
use App\Form\Platform\CMS\FormFieldType;
...
{
    private const string redirectToRoute = 'admin_v1_cms_form_field';

    #[Route('/', name: 'admin_v1_cms_form_field', methods: ['GET'])]
    ...
    #[Route('/new/', name: 'admin_v1_cms_form_field_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/edit/{entity}', name: 'admin_v1_cms_form_field_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/delete/{entity}', name: 'admin_v1_cms_form_field_delete', methods: ['GET'])]
