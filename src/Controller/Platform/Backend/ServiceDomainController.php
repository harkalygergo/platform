...
{
    #[Route('/{_locale}/admin/v1/domains/', name: 'admin_v1_home_domains')]
    ...
    // add new domain
    #[Route('/{_locale}/admin/v1/domains/new', name: 'admin_v1_home_domains_new')]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_v1_home_domains', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{_locale}/admin/v1/domains/edit/{id}', name: 'admin_v1_home_domains_edit', requirements: ['id' => '\d+'])]
    ...
    // delete
    #[Route('/{_locale}/admin/v1/domains/delete/{id}', name: 'admin_v1_home_domains_delete', requirements: ['id' => '\d+'], methods: ['GET'])]
