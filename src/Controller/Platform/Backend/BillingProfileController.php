...
{
    #[Route('/{_locale}/admin/v1/billing-profiles/', name: 'admin_v1_sys_billing_profiles')]
    ...
    #[Route('/{_locale}/admin/v1/billing-profiles/add', name: 'admin_v1_sys_billing_profiles_add')]
    public function add(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_v1_sys_billing_profiles');
        }
    ...
    #[Route('/{_locale}/admin/v1/billing-profiles/edit/{id}', name: 'admin_v1_sys_billing_profiles_edit')]
    ...
    #[Route('/{_locale}/admin/v1/billing-profiles/delete/{id}', name: 'admin_v1_sys_billing_profiles_delete')]
