...
{
    private const string redirectToRoute = 'ecom_v1_product_categories';

    #[Route('/', name: 'ecom_v1_product_categories')]
    ...
    */
    ...
    #[Route('/new/', name: 'ecom_v1_product_categories_new', methods: ['GET', 'POST'])]
    public function new(Request $request): Response
    {
        $form = $this->createForm(ProductCategoryType::class, null, [
            'currentInstance' => $this->currentInstance,
    ...
    #[Route('/edit/{entity}', name: 'ecom_v1_product_categories_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/delete/{id}', name: 'ecom_v1_product_categories_delete')]
