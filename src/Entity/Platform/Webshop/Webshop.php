...
class Webshop
{
    ...
    #[ORM\ManyToOne(targetEntity: Instance::class, inversedBy: 'webshops')]
    ...
    #[ORM\ManyToMany(targetEntity: Product::class, inversedBy: 'webshops')]
    #[ORM\JoinTable(name: 'shop_webshop_product')]
    private Collection $products;

    #[ORM\ManyToMany(targetEntity: ProductCategory::class, inversedBy: 'webshops')]
    #[ORM\JoinTable(name: 'shop_webshop_product_categories')]
    ...
    public function addProductCategory(ProductCategory $productCategory): self
    {
        if (!$this->productCategories->contains($productCategory)) {
            ...
            $productCategory->addWebshop($this);
        }
    ...
    public function removeProductCategory(ProductCategory $productCategory): self
    {
        if ($this->productCategories->removeElement($productCategory)) {
            $productCategory->removeWebshop($this);
        }
